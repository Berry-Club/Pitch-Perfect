...
@Mod(com.aaronhowser.mods.pitchperfect.PitchPerfect.MOD_ID)
object PitchPerfect {

    const val MOD_ID = "pitchperfect"
    val LOGGER: Logger = LogManager.getLogger(com.aaronhowser.mods.pitchperfect.PitchPerfect.MOD_ID)

    init {
        com.aaronhowser.mods.pitchperfect.PitchPerfect.LOGGER.log(Level.INFO, "Pitch Perfect loaded!")
        ...
        com.aaronhowser.mods.pitchperfect.ModSounds.register(MOD_BUS)
