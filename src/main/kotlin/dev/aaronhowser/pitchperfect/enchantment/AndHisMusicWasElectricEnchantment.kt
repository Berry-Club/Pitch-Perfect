...
import dev.aaronhowser.pitchperfect.ModSounds
import dev.aaronhowser.pitchperfect.config.ServerConfig
import dev.aaronhowser.pitchperfect.event.ModScheduler
import dev.aaronhowser.pitchperfect.item.InstrumentItem
import dev.aaronhowser.pitchperfect.packet.ModPacketHandler
import dev.aaronhowser.pitchperfect.packet.SpawnElectricParticlePacket
...
import dev.aaronhowser.pitchperfect.utils.ServerUtils
            ...
            if (attacker is Player) {
                electricItemStack.hurtAndBreak(1, attacker) { user: LivingEntity ->
                    user.getLevel().playSound(
                        ...
                        dev.aaronhowser.pitchperfect.ModSounds.GUITAR_SMASH.get(),
                        SoundSource.PLAYERS,
                        1f,
                        1f
                    )
