package dev.aaronhowser.pitchperfect.event

import dev.aaronhowser.pitchperfect.PitchPerfect
import dev.aaronhowser.pitchperfect.config.ServerConfig
import dev.aaronhowser.pitchperfect.enchantment.AndHisMusicWasElectricEnchantment
import dev.aaronhowser.pitchperfect.item.InstrumentItem
import dev.aaronhowser.pitchperfect.item.ModItems
import dev.aaronhowser.pitchperfect.utils.CommonUtils.isMonster
...
@Suppress("unused")
@Mod.EventBusSubscriber(modid = dev.aaronhowser.pitchperfect.PitchPerfect.MOD_ID)
object ModEvents {
